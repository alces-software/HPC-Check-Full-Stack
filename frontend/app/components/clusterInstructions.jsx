...
export default function Results() {
   ...
   const clusters = Array.isArray(allClusters) ? allClusters.map((cluster) => cluster.name) : [];
      ...
      <main className="flex min-h-screen items-center justify-center">
         <div className="w-full max-w-6xl">
            <div className="rounded-3xl border border-white/10 bg-white/10 p-8 shadow-2xl backdrop-blur-xl">
               <div className="mb-8">
                  <h1 className="text-4xl font-bold text-white">Cluster Instructions</h1>

                  <p className="mt-2 text-slate-300">Select a cluster to view its instructions.</p>
               </div>
                        ...
                        {selectedCluster && instructions.length > 0 && (
                           <div className="mt-4 flex flex-col items-end text-md">
                              <div className="text-slate-400">
                                 Cluster:{' '}
                                 <span className="text-slate-200">{selectedCluster.name}</span>
                              </div>

                              <div className="text-slate-400">
                                 Instructions:{' '}
                                 <span className="text-slate-200">{instructions.length}</span>
                              </div>
                           </div>
                        )}
                     </>
